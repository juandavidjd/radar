...
OUTPUT_PATH = r'C:\RadarPremios\data\limpio\cuarto_resumen_matriz_aslu.csv'
...
# Agregar columnas binarizadas para presencia de '3'
...
conn.close()
print(f'✅ Resumen del dígito 3 exportado en: {OUTPUT_PATH}')
